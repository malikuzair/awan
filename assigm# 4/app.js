...
// // ++++++++++++Q6++++++
// // Initialize an empty string to store the series
// var series = "";

// // Loop from 1 to 15 and add each number to the series string
// for (var i = 1; i <= 15; i++) {
//   // Append the current number to the series string
//   series += i;
